...
data_X <- read.table("/Users/...", header = TRUE, sep = "\t")# add your directory where you saved your data tableX
data_Y <- read.table("/Users/...", header = TRUE, sep = "\t")# add your directory where you saved your data tableY
...
list_param <- list(
    ...
    heatmap_fontsize = 7,                                                    # Correlation plot: font size for the variables' names
    ...
    plotCorCCA_corr_min = 0.6,                                               # Correlation and CCA plots: threshold determining the minimum correlation to be considered between variables
    ...
    plotCorCCA_label_size = 5,                                               # Correlation and CCA plots: label size for the nodes' names
    ...
    plotCCA_corr_min = 0.6,                                                  # CCA plot: threshold determining the minimum correlation to be considered between variables and canonical variates 
    ...
    plots_x_color = "aquamarine4",                                                 # color for variables of the first dataset (data_X)
    plots_y_color = "blue4",                                                  # color for variables of the second dataset (data_Y)
    plots_cv_color = "azure4",                                                 # color for canonical variates (and their associated short label)
    plots_neg_color = "aquamarine4",                                                 # color for highlighting negative correlations or negative coefficient estimates 
    plots_pos_color = "blue4",                                                # color for highlighting positive correlations or positive coefficient estimates 
